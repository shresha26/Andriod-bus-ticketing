    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(I);
                //signup ma click gare apxi Main activity open vai raxa ahile
                //signup ma kei kaamai gareko xainau ani kasari hunxa code copy paste ho hehe kehi garexaina
                //login and registermatra ganu parne ho app ma...ki kei feature pani raakhne ho
                //rakhne ho but aile registeration ra login matra ho....bus ticketing and networking garna lako ho
                //hera firebase ma data kasari push grne vaner
            }
        });
